# Core Financiero — Caja Trujillo
## Documento Técnico y Funcional

| Campo | Valor |
|---|---|
| **Proyecto** | Core Financiero — Caja Trujillo |
...
El sistema es el **Core Financiero de Caja Trujillo**, diseñado para apoyar la gestión de créditos, cartera, captaciones e indicadores institucionales mediante una arquitectura basada en FastAPI y PostgreSQL.
