...
> Base: Procedimiento de otorgamiento de créditos utilizado como referencia para el desarrollo del Core Financiero de Caja Trujillo, utilizando el esquema real de `bd_core_financiero`.
